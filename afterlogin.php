...
<body>
    ...
    <nav style="display: flex; justify-content: space-between;background-color: #e7ebe6; padding: 10px 0; height: 8.5vh;">
        <div style="display: flex;"><i class="fa fa-reorder" onclick="callsh()"
            ...
            <h3 style="cursor:pointer; padding-top: 3px; padding-left:30px;"><?php echo $fname." ".$lname; ?></h3>
    ...
    <div style="display: flex;height: 91.5vh;">
        <nav style="width: 450px; padding: 0; background-color: #e7ebe6;" id="sh_menu">
            ...
            <ul style="width: 100%; background-color: #e7ebe6; padding-right: 40px;">
                ...
                <li style="list-style: none; background-color: #545453; padding: 10px 20px; text-align: center; border-radius: 10px; margin-bottom: 13px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;" onclick="comp()" href="#">Complaint</a>
                </li>
                <li style="display:none; padding: 10px 20px;list-style: none; background-color: grey; text-align: center; border-radius: 10px; margin-bottom: 5px; margin-top: 13px;" id="m_comp">
                    <a style="color: white; font-size: 18px; text-decoration: none; padding: 10px 20px;" onclick="makecomplaint()" href="#">Make Complaint</a>
                </li>

                <li style="list-style: none; background-color: grey; padding: 0px 20px; text-align: center; border-radius: 10px; margin-bottom: 5px; margin-top: 5;">
                    <a style="color: white; font-size: 18px; text-decoration: none;display:none; padding: 10px 20px;" onclick="completed()" id="c_comp" href="#">Completed</a>
                </li>

                <li style="list-style: none; background-color: grey; padding: 0px 20px; text-align: center; border-radius: 10px; margin-bottom: 5px; margin-top: 5px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;display:none; padding: 10px 20px;" onclick="inpro()" id="i_comp" href="#">Inprogress</a>
                </li>
                <li style="list-style: none; background-color: grey; padding: 0px 20px; text-align: center; border-radius: 10px; margin-bottom: 5px; margin-top: 5px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;display:none; padding: 10px 20px;" onclick="pending()" id="p_comp" href="#">Pending</a>
                </li>
                <li style="list-style: none; background-color: grey; padding: 0px 20px; text-align: center; border-radius: 10px; margin-bottom: 15px; margin-top: 5px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;display:none; padding: 10px 20px;" onclick="history()" id="h_comp" href="#">Complaint history</a>
                </li>
                <li style="list-style: none; background-color: #545453; padding: 10px 20px; text-align: center; border-radius: 10px; margin-bottom: 13px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;" onclick="personal()" href="#">Personal Info</a>
                </li>
                <li style="list-style: none; background-color: grey; text-align: center; border-radius: 10px; margin-bottom: 5px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;display:none; padding: 10px 20px;" onclick="editinfo()" id="e_info" href="#">Edit Info</a>
                </li>
                <li style="list-style: none; background-color: grey; text-align: center; border-radius: 10px;">
                    <a style="color: white; font-size: 18px; text-decoration: none;display:none; padding: 10px 20px;" onclick="changepass()" id="c_pass" href="#">Change password</a>
                </li>
        ...
        <div id="main" style="width:100%;">
            ...
            <div class="" id="dashboard" style="width:100%;display:block;padding:20px;">
                ...
                <div style="border: 2px solid black; padding-left: 10px; padding-right: 10px; padding-top: 20px; padding-bottom: 10px; border-radius: 15px; width: 260px;">
                    ...
                    <p onclick="completed()" style="background-color: #545453;color: white;cursor:pointer; padding: 10px 20px; width: 100%; text-align: center; border-radius: 15px; font-size: 20px;">Review</p>   
                </div>
            </div>
        </div>
        ...
        <div class="" id="editinfo"
            ...
            <form class="form" action="userupdateinfo.php" method="POST" style="width:100%;">
                <span id="span">First Name</span><input type="text" name="fname" class="form-control in1"
                    placeholder="First name" value="<?php echo $fname; ?>"><br />
                <span id="span">Last Name</span><input type="text" name="lname" class="form-control in1"
                    placeholder="Last name" value="<?php echo $lname; ?>"><br />
                <span id="span">Email</span><input type="text" name="email" class="form-control in1" placeholder="Email"
                    value="<?php echo $email; ?>"><br />
                <span id="span">Phone number</span><input type="text" name="phone" class="form-control in1"
                    placeholder="Phone number" value="<?php echo $phone; ?>"><br />
                ...
                <input type="submit" class="btn btn-success "
                    style="width:auto ;padding:10px;padding-left:50px;padding-right:50px;" value="save"><br />
            </form>
        </div>

        <!----------------------------------------------------------------------------------------editinfo-->
        <!----------------------------------------------------------------------------------------makecomp-->
        <div class="" id="makecomplaint"
            style="width:97%;display:none;border-radius:15px;padding:15px;margin:20px;background-color:#dfe0de;border:1px solid #545453;">
            <h4>Make a complaint
                <hr />
            </h4>
            <form class="form" action="usermakecomp.php" method="POST" style="width:100%;"
                ...
                <input type="text" name="subcategory"
                    style="width:30%;border-radius:5px;height:37px; border:.8px solid aqua;"
                    placeholder="Please Enter a subcategory..">
                <br /><br />
                <span id="span2">Nature of Complaint</span><input type="text" name="nature" class="form-control in2"
                    placeholder="Regarding to ...."><br />
                <span id="span">Complaint</span>
                <textarea name="comp" class="form-control in1"
                    placeholder="Feel free to write. Your complaint is secure." style="height:200px;"></textarea><br />
                <br /><span id="span">Regarding File (If any) Max Size 2Mb</span><input name="f2" type="file"
                    class="form-control">
                <br />
                <input type="submit" class="btn btn-success "
                    style="width:auto ;padding:10px;padding-left:50px;padding-right:50px;" value="Send"><br />
            </form>
        </div>
	...
	if($num==0)
	{
        ...
        <div class="" id="changepass"
            ...
            <form class="form" action="userchangepass.php" method="POST" style="width:100%;">
                ...
                <span id="span">Enter OLD password</span><input type="password" name="oldpass" class="form-control in1"
                    placeholder="Old Password..."><br />
                <span id="span">Enter new Password</span><input type="password" name="newpass" class="form-control in1"
                    placeholder="New Password..."><br />
                <span id="span">Re-enter new password</span><input type="password" name="renewpass"
                    class="form-control in1" placeholder="Re-enter New Password..."><br />
